          ...
          {repositories.map((repo) => (
            ...
            >
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-300">{repo.path}</p>
                </div>
            </div>
            ...
            <div className="flex items-center space-x-2">
              <button
                ...
                className="p-2 text-gray-600 hover:text-primary-600 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-primary-400 dark:hover:bg-gray-700 rounded-md flex items-center justify-center"
